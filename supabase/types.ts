// Auto-generated via Supabase project rnatvptcbafxeznvqzcg
export type Json =
  | string
  | number
  | boolean
...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      is_team_member: { Args: { target_team: string }; Returns: boolean };
      reject_expense: {
        Args: { p_comment?: string; p_expense_id: string };
        Returns: undefined;
      };
    };
    Enums: {
